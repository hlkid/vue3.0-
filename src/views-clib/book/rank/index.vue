...
<!--      </el-form-item>-->
      <el-form-item prop="examineStatus">
        <el-select v-model="searchForm.periodChildType"  clearable placeholder="请选择排行类型">
          <el-option
...
<!--              &lt;!&ndash;                v-if="scope.row.examineStatus == 0"&ndash;&gt;-->
<!--              &lt;!&ndash;              >未审核</el-link>&ndash;&gt;-->
<!--              &lt;!&ndash;              <el-link&ndash;&gt;-->
<!--              &lt;!&ndash;                :underline="false"&ndash;&gt;-->
<!--              &lt;!&ndash;                type="success"&ndash;&gt;-->
<!--              &lt;!&ndash;                v-else-if="scope.row.examineStatus == 1"&ndash;&gt;-->
<!--              &lt;!&ndash;              >已审核</el-link>&ndash;&gt;-->
<!--              &lt;!&ndash;              <el-link&ndash;&gt;-->
<!--              &lt;!&ndash;                :underline="false"&ndash;&gt;-->
<!--              &lt;!&ndash;                type="success"&ndash;&gt;-->
<!--              &lt;!&ndash;                v-else-if="scope.row.examineStatus == 2"&ndash;&gt;-->
<!--              &lt;!&ndash;              >已发送</el-link>&ndash;&gt;-->
<!--              &lt;!&ndash;              <el-link&ndash;&gt;-->
<!--              &lt;!&ndash;                :underline="false"&ndash;&gt;-->
<!--              &lt;!&ndash;                type="danger"&ndash;&gt;-->
<!--              &lt;!&ndash;                v-else&ndash;&gt;-->
<!--              &lt;!&ndash;              >已驳回</el-link>&ndash;&gt;-->
<!--              <el-link-->
<!--                :underline="false"-->
<!--                type="success"-->
...
<!--              <el-button size="mini" @click.stop="handleEdit(scope.row)"  v-if="hasButton('edit')"><i class="fa fa-pencil fa-fw"></i>编辑</el-button>-->
<!--              <el-button-->
<!--                size="mini"-->
<!--                type="primary"-->
...
<script>
  ...
  import { getRank,getAuthStatus,save,sendExamine,examine,publish,deleteById,detail,update} from "@/api/clib/book";
  ...
  export default {
    ...
    methods:{
      ...
      //好书推荐列表
      getList(){
        getRank(this.searchForm).then(res=>{
          if (res.code == 200){
      ...
      //查看 type 为 1代表是查看
      handleView(row){
        this.$router.push({name:'book_rank_look',params:{type:1,id:row.id}})
      },
      //图书管理
      bookRecommend(row){
        this.$router.push({name:'book_rank_edit',params:{id:row.id}})
      },
